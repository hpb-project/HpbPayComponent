...
contract HpbPay{
    ...
    /**
     * 通过合约管理员添加商户
     * @param _merchantAddr 商户账户地址
     * @param _publicKey 商户公钥
     * @param _desc 商户描述
     */
    function addMerchant(
        ...
        emit AddMerchant(_merchantAddr,_desc);
    }
    /**
     * 商户更新自己的公钥和描述信息
     * @param _publicKey 商户公钥
     ...
     * @param _from 付款方账户地址
     * @param _to 收款方账户地址
     * @param _value 付款金额(HPB)
     * @param _orderId 商户本地业务订单号
     * @param _backUrl HPB支付APP返回到商户本地APP的url
     * @param _desc 订单的详细描述
     */
    ...
    function _cancelOrderWithPayer(
     ...
     /**
     *查看付款者的订单,供内部调用
     * @param orderId 商户本地业务订单号
     * @param payerAddr 付款者账户地址
     */
    ...
    function fetchOrdersForMerchantByAdmin(
        ...
        return _fetchOrdersForMerchant(_merchantAddr);
    }
    /**
     *付款者查询自己所有的订单信息
     */
    ...
    function fetchOrdersForPayerByAdmin(
        ...
        return _fetchOrdersForPayer(_payerAddr);
    }
    /**
     *商户查询自己所有已取消状态的订单信息
     */
    ...
    function fetchCancelledOrdersForMerchantByAdmin(
        ...
        return _fetchCancelledOrdersForMerchant(_merchantAddr);
    }
    /**
     *商户查询自己所有已支付状态的订单信息
     */
    ...
    function fetchPaidOrdersForMerchantByAdmin(
      ...
      return _fetchPaidOrdersForMerchant(_merchantAddr); 
    }
    /**
     *商户查询自己的所有已创建状态的订单信息
     */
    ...
    function fetchCreatedOrdersForMerchantByAdmin(
        ...
        return _fetchCreatedOrdersForMerchant(_merchantAddr);
    }
    /**
     *付款者查询自己所有已取消状态的订单信息
     */
    ...
    function fetchCancelledOrdersForPayerByAdmin(
        ...
        return _fetchCancelledOrdersForPayer(_payerAddr);
    }
    /**
     *付款者查询自己所有已支付状态的订单信息
     */
    ...
    function fetchPaidOrdersForPayerByAdmin(
        ...
        return _fetchPaidOrdersForPayer(_payerAddr);
    }
    /**
    ...
    function fetchCreatedOrdersForPayerByAdmin(
        ...
        return _fetchCreatedOrdersForPayer(_payerAddr);
    }
    /**
     *管理员查询所有已创建状态的订单信息
     */
